:root {
  ...
  --color-sf-rating-selected-color: var(--color-sf-content-text-color);
  ...
  --color-sf-msg-success-color-alt1: var(--color-sf-success);
...
.e-dark-mode {
  ...
  --color-sf-msg-color-alt1: var(--color-sf-content-text-color);
  --color-sf-msg-bg-color-alt1: transparent;
  --color-sf-msg-border-color-alt1: var(--color-sf-msg-bg-color);
  --color-sf-msg-color-alt2: #242424;
  --color-sf-msg-bg-color-alt2: #adadad;
  --color-sf-msg-border-color-alt2: var(--color-sf-msg-bg-color-alt2);
  --color-sf-msg-icon-color: var(--color-sf-msg-bg-color-alt2);
  --color-sf-msg-icon-color-alt1: var(--color-sf-msg-icon-color);
  --color-sf-msg-icon-color-alt2: #fff;
  ...
  --color-sf-msg-success-color-alt1: var(--color-sf-success);
  --color-sf-msg-success-bg-color-alt1: transparent;
  --color-sf-msg-success-border-color-alt1: var(--color-sf-msg-success-color);
  --color-sf-msg-success-color-alt2: #fff;
  --color-sf-msg-success-bg-color-alt2: #107c10;
  --color-sf-msg-success-border-color-alt2: var(--color-sf-msg-success-bg-color-alt2);
...
.e-high-contrast {
  ...
  --color-sf-table-bg-color-selected: var(--color-sf-black);
  --color-sf-content-text-color: #fff;
...
.e-dropdown-btn.e-btn:focus-visible {
  -webkit-box-shadow: inset 0 0 0 1px var(--color-sf-shadow-color), inset 0 0 0 2px #fff;
          box-shadow: inset 0 0 0 1px var(--color-sf-shadow-color), inset 0 0 0 2px #fff;
}
...
.e-css.e-btn-group input:focus-visible + label.e-btn {
  -webkit-box-shadow: inset 0 0 0 1px var(--color-sf-shadow-color), inset 0 0 0 2px #fff !important;
          box-shadow: inset 0 0 0 1px var(--color-sf-shadow-color), inset 0 0 0 2px #fff !important;
}
...
.e-primary.e-flat .e-progress {
  background: rgba(15, 108, 189, 0.5) !important; /* stylelint-disable-line declaration-no-important */
}

.e-success.e-outline .e-progress,
.e-success.e-flat .e-progress {
  background: rgba(16, 124, 16, 0.5) !important; /* stylelint-disable-line declaration-no-important */
}

.e-danger.e-outline .e-progress,
.e-danger.e-flat .e-progress {
  background: rgba(197, 15, 31, 0.5) !important; /* stylelint-disable-line declaration-no-important */
}

.e-warning.e-outline .e-progress,
.e-warning.e-flat .e-progress {
  background: rgba(247, 99, 12, 0.5) !important; /* stylelint-disable-line declaration-no-important */
}

.e-info.e-outline .e-progress,
.e-info.e-flat .e-progress {
  background: rgba(49, 175, 204, 0.5) !important; /* stylelint-disable-line declaration-no-important */
}

.e-progress-btn.e-warning .e-spinner-pane .e-spinner-inner .e-spin-fluent2 .e-path-circle {
  stroke: rgba(36, 36, 36, 0.2) !important; /* stylelint-disable-line declaration-no-important */
}

.e-progress-btn.e-warning.e-flat:focus .e-spinner-pane .e-spinner-inner .e-spin-fluent2 .e-path-circle {
  stroke: #ebf3fc !important; /* stylelint-disable-line declaration-no-important */
}
