...
$shadow-color: mapcolorvariable('shadow-color');
$shadow-color1: mapcolorvariable('shadow-color1');
...
$overlay-bg-color: rgba($overlay-bg, .4) !default;
