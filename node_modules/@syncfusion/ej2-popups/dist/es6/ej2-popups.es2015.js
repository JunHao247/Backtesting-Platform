...
function getElementRight() {
    const popupWidth = (element && (element.classList.contains('e-date-wrapper') || element.classList.contains('e-datetime-wrapper') || (element.classList.contains('e-ddl') && element.classList.contains('e-rtl')) || element.classList.contains('e-date-range-wrapper'))) ? (popupRect ? popupRect.width : 0) :
...
function setPopup(element, pos, elementRect) {
    ...
    if (element.offsetParent) {
        const transformStyle = getComputedStyle(element.offsetParent).transform;
...
export { Animation, AnimationSettings, ButtonProps, Dialog, DialogUtility, Popup, PositionData, Spinner, Tooltip, calculatePosition, calculateRelativeBasedPosition, createSpinner, destroy, fit, flip, getMaxZindex, getScrollableParent, getZindexPartial, hideSpinner, isCollide, setSpinner, showSpinner };
