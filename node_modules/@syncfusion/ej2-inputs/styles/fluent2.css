...
.e-float-input.e-control-wrapper.e-disabled {
  ...
  background: var(--color-sf-content-bg-color-alt1);
  color: var(--color-sf-content-text-color-disabled);
  background-image: -webkit-gradient(linear, left top, right top, color-stop(0, var(--color-sf-border-disabled)), color-stop(33%, var(--color-sf-border-disabled)), color-stop(0, transparent));
...
.e-filled.e-input-group.e-control-wrapper:not(.e-disabled) .e-clear-icon:hover {
  color: rgba(var(--color-sf-icon-color-hover));
}
...
.e-bigger .e-control-wrapper.e-slider-container.e-vertical .e-slider.e-scale,
.e-control-wrapper.e-slider-container.e-bigger.e-vertical .e-slider.e-scale {
  margin-top: -4px;
}
.e-bigger .e-control-wrapper.e-slider-container.e-vertical .e-slider.e-v-scale,
.e-control-wrapper.e-slider-container.e-bigger.e-vertical .e-slider.e-v-scale {
  left: calc(50% - 14px);
}
