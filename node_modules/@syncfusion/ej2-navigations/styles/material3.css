...
.e-hscroll .e-scroll-overlay.e-scroll-left-overlay {
  background-image: -webkit-gradient(linear, left top, right top, from(rgba(var(--color-sf-surface))), color-stop(0%, 1), color-stop(rgba(var(--color-sf-surface))), to(0));
...
.e-hscroll .e-scroll-overlay.e-scroll-right-overlay {
  background-image: -webkit-gradient(linear, left top, right top, from(rgba(var(--color-sf-surface))), color-stop(0%, 0), color-stop(rgba(var(--color-sf-surface))), to(1));
...
.e-vscroll.e-rtl .e-scroll-nav {
  background: -webkit-gradient(linear, left bottom, left top, from(rgba(103, 80, 164, 0.08)), to(rgba(103, 80, 164, 0.08))), -webkit-gradient(linear, left bottom, left top, from(rgba(var(--color-sf-primary), 0.05)), to(rgba(var(--color-sf-primary), 0.05))), rgba(var(--color-sf-surface));
...
.e-tab .e-tab-header .e-toolbar-pop {
  ...
  border-radius: 4px;
  -webkit-box-shadow: 0 2px 6px 2px rgba(0, 0, 0, 0.15), 0 1px 2px 0 rgba(0, 0, 0, 0.3) rgba(0, 0, 0, 0.1), 0 2px 6px 2px rgba(0, 0, 0, 0.15), 0 1px 2px 0 rgba(0, 0, 0, 0.3) rgba(0, 0, 0, 0.13);
